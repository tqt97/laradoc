<header class="sticky top-0 z-50 bg-white1 px-4 py-5 sm:px-6 lg:px-8 dark:bg-zinc-900 bg-gray-50 shadow-sm">
    <div class="max-w-7xl mx-auto">
        <div class="col-span-12 flex flex-none flex-wrap items-center justify-between xl:col-span-10 xl:col-start-2">
            ...
            <div class="relative flex basis-0 items-center justify-end gap-3 sm:gap-8 md:grow lg:gap-6">
                <x-prezet.search />
                <a class="group" aria-label="GitHub" href="https://github.com/prezet/prezet" target="_blank">
