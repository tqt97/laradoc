...
<div
    ...
    <div class="relative z-10 w-full flex flex-col items-center">
        ...
        {{-- Headline Section --}}
        <div class="text-center max-w-4xl mb-16 px-4">
            <h1
            ...
            <div class="relative inline-block px-6">
                <svg class="absolute -top-6 -left-2 size-12 text-zinc-300 dark:text-zinc-800/50 -z-10" fill="currentColor"
                    viewBox="0 0 32 32">
                    <path
                ...
                <p class="text-lg md:text-xl text-zinc-500 dark:text-zinc-400 font-medium italic leading-relaxed px-4">
                    {{ $hero['description'] }}
                </p>
                <svg class="absolute -bottom-6 -right-2 size-12 text-zinc-300 dark:text-zinc-800/50 -z-10 rotate-180"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl w-full px-4 mb-20">
            @foreach ($hero['features'] as $f)
                <a href="{{ route($f['route']) }}"
                    class="group relative flex flex-row items-center justify-between p-4 rounded-2xl bg-zinc-900/[0.02] dark:bg-white/[0.02] border border-zinc-900/5 dark:border-white/5 transition-all duration-500 hover:bg-white dark:hover:bg-zinc-900 hover:shadow-2xl hover:shadow-primary-500/5 hover:-translate-y-1 overflow-hidden">
        ...
        <a href="#series" class="group flex flex-col items-center gap-3">
            ...
            <span
                class="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 dark:text-zinc-600 group-hover:text-primary-500 transition-colors duration-300">Explore</span>
        </a>
    </div>
</div>
