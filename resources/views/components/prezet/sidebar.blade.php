...
<div x-show="showSidebar" x-trap.inert.noscroll="showSidebar"
    ...
    <div class="min-h-full w-full max-w-xs bg-white px-4 pt-24 pb-12 sm:px-6 dark:bg-gray-900"
...
<div class="hidden lg:relative lg:block lg:flex-none">
    ...
    <div class="absolute top-16 right-0 bottom-0 hidden h-12 w-px bg-gradient-to-t from-gray-200 dark:from-gray-800">
    </div>
