@props(['document', 'readingTime', 'views' => 0, 'hideImage' => false])
...
<div {{ $attributes->merge(['class' => '']) }}>
    ...
    <div class="flex flex-col gap-6 border-b border-zinc-200 pb-8 dark:border-zinc-800">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="flex flex-wrap items-center gap-y-4 gap-x-6 text-xs font-bold text-zinc-500 dark:text-zinc-400">
                ...
                <span class="hidden sm:block text-zinc-300 dark:text-zinc-700">&bull;</span>
                <span class="flex items-center gap-1.5 leading-none">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-3.5 mb-0.5">
            ...
            <x-prezet.social-share :url="route('prezet.show', $document->slug)" :title="$document->frontmatter->title" />
        </div>
    </div>
