...
<x-prezet.template>
    ...
    <div id="articles" class="py-12 lg:py-12" x-data="{ createModal: false, deleteModal: false, deleteUrl: '' }">
                        ...
                        <div x-show="editing" x-cloak
                            ...
                            <form action="{{ route('links.update', $link) }}" method="POST" class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-1">
                                        <label class="text-[10px] font-bold uppercase tracking-wider text-zinc-500">Tiêu
                                            đề</label>
                                ...
                                <div class="mt-4 text-center sm:mt-0 sm:ml-6 sm:text-left">
                                    ...
                                    <div class="mt-3">
                                        <p
                                            ...
                                            Bạn có chắc chắn muốn xóa liên kết này không? Hành động này không thể hoàn
                                            tác.
                                        </p>
                                    </div>
                                </div>
