            ...
            @foreach ($series as $item)
                <div
                    ...
                    <div class="grow">
                        ...
                        <p class="text-zinc-500 dark:text-zinc-400 leading-relaxed line-clamp-3 text-sm">
                    ...
                    <div
                        ...
                        <div
                            class="text-primary-500 flex items-center gap-2 text-sm font-bold opacity-60 group-hover:opacity-100 transition-opacity">
                            Bắt đầu đọc
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="2.5" stroke="currentColor" class="size-4 group-hover:translate-x-1 transition-transform">
