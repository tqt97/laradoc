...
<x-prezet.template>
    ...
    <div
        ...
        <div class="relative z-10 max-w-7xl px-4">
            ...
            <a href="#articles" class="group inline-flex flex-col items-center">
                <p
    ...
    <div id="articles" class="py-12 lg:py-24 scroll-mt-20" hx-boost="true" hx-select="#articles-content"
        hx-target="#articles-content" hx-push-url="true" hx-swap="outerHTML"
        onhtmx:after-settle="window.scrollTo({ top: document.getElementById('articles').offsetTop - 100, behavior: 'smooth' })">
