    ...
    */
    'hero' => [
        ...
        'features' => [
            ...
            [
                'label' => 'Kiến thức',
                'sub' => 'Ôn tập kiến thức',
                'route' => 'knowledge.index',
                'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.174L10.74 12l-6.48 1.826a.75.75 0 000 1.448l6.48 1.826a.75.75 0 00.412 0l6.48-1.826a.75.75 0 000-1.448L11.26 12l6.48-1.826a.75.75 0 000-1.448l-6.48-1.826a.75.75 0 00-.412 0l-6.48 1.826a.75.75 0 000 1.448z" /><path stroke-linecap="round" stroke-linejoin="round" d="M12 18l4 1.125V21l-4-1.125-4 1.125v-1.875L12 18z" />',
            ],
            [
                'label' => 'Nhật ký',
                'sub' => 'Kể chuyện trải nghiệm',
                'route' => 'stories.index',
                'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />',
            ],
            [
